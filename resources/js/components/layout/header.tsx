...
import { InstagramIcon, LinkedInIcon } from '../logos/logos';
    ...
    return (
        <header
            className={cn(
                ...
                getWidthClasses(),
                'my-5 flex items-center justify-between rounded-4xl p-3 lg:rounded-renovacom lg:p-5 lg:py-6',
            )}
        >
            <img
                src="/assets/logo.png"
                    ...
                    {navigationItems.map((item) => (
                        <li
                            ...
                            className={cn(
                                ...
                                item.isCurrent ? 'font-bold' : 'font-normal',
                            )}
                        >
